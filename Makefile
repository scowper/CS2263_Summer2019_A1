...
##################################################################
# Test Cases
test: exit_test push_test peek_test pop_test compound_test my_test
...
my_test: my_test1
my_test1: Stack
	./Stack < Data/MyTest.input > MyTest.result
	./TestPassed.sh MyTest.result Data/MyTest.expected
